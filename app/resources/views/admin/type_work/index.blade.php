            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <div class="card card-primary collapsed-card col-md-6">
                        <div class="card-header">
                            <h3 class="card-title">Внутренний ремонт оборудования</h3>
                        ...
                        <div class="card-body" style="display: none;">
                            Ремонт оборудования без помощи внешних организаций
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <div class="card card-primary collapsed-card col-md-6">
                        <div class="card-header">
                            <h3 class="card-title">Выдача оборудования сотруднику</h3>
                    ...
                    <div class="card card-primary collapsed-card col-md-6">
                        <div class="card-header">
                            <h3 class="card-title">Замена монитора</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                        class="fas fa-plus"></i>
                                </button>
                    ...
                    <div class="card card-primary collapsed-card col-md-6">
                        <div class="card-header">
                            <h3 class="card-title">Заправка бумаги в принтер</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                        class="fas fa-plus"></i>
                                </button>
                    ...
                    <div class="card card-primary collapsed-card col-md-6">
                        <div class="card-header">
                            <h3 class="card-title">Заправка картриджа</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                        class="fas fa-plus"></i>
                                </button>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body" style="display: none;">
                            Заправка тонером картриджа лазерного принтера
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <div class="card card-primary collapsed-card col-md-6">
                    ...
                    <div class="card card-primary collapsed-card col-md-6">
                        <div class="card-header">
                            <h3 class="card-title">Кроссировка сети</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                        class="fas fa-plus"></i>
                                </button>
                    ...
                    <div class="card card-primary collapsed-card col-md-6">
                        <div class="card-header">
                            <h3 class="card-title">Обучение сотрудников</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                        class="fas fa-plus"></i>
                                </button>
