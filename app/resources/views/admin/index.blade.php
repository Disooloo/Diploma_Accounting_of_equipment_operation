  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
          ...
          <div class="card-header">
            <h3 class="card-title">Выбрать статистику</h3>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>150 / <span> 233 </span></h3>

                <p>Устройств работает</p>
              </div>
              <div class="icon">
    ...
    <!-- /.content -->
            ...
            <div class="card bg-gradient-primary">
              ...
              <div class="card-body">
								<iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ad7eb63951f8881cd67c8366d8a45767ea229005eda19eb688a7c882e211c2a33&amp;source=constructor" width="100%" height="400px" frameborder="0"></iframe>
              </div>
              <!-- /.card-body-->
              <div class="card-footer bg-transparent">
                <div class="row">
