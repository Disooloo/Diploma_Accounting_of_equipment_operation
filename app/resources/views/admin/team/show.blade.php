            ...
            <div class="card card-primary card-outline">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#timeline" data-toggle="tab">Данные сотрудника</a></li>
                    ...
                    <div class="timeline timeline-inverse">
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          <h3 class="timeline-header"><a href="#">Системная информация</a> принят(а) на работу</h3>

                          <div class="timeline-body">
                           Прибывшему сотруднику просьба прочитать требования и внутренние правила компании.
                          </div>
                          <div class="timeline-footer">
                            <a href="#" class="btn btn-primary btn-sm">Прочитать требования</a>
                          </div>
                        </div>
                      </div>
                      <!-- END timeline item -->
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header border-0"><a href="#">Системная информация</a> документы сотрудника
                          </h3>
 														<div class="timeline-footer">
															<div class="card">
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header"><a href="#">Системная информация </a> Уволен из организации</h3>
                          <div class="timeline-body">
															<table class="table table-bordered">
																	<thead>
																		<tr>
                      ...
                      <div>
                        <i class="far fa-clock bg-gray"></i>
                          ...
                          <h3 class="timeline-header"><a href="#">Системная информация </a></h3>
                          <div class="timeline-body">
															<a href="#" class="btn btn-danger btn-sm">Удалить сотрудника из БД</a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputName1" placeholder="Фамилия">
                        </div>
                      </div>
											 <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Отчество</label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputName2" placeholder="Отчество">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Навыки</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience" placeholder="Навыки"></textarea>
                        </div>
                      </div>
											 <div class="form-group row">
                        <label for="inputExperience1" class="col-sm-2 col-form-label">Образование</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience1" placeholder="Образование"></textarea>
                        </div>
                      </div>
											<div class="form-group row">
                        <label for="inputExperience2" class="col-sm-2 col-form-label">Записи</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience2" placeholder="Записи"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <div class="checkbox">
                            <label>
                              <input type="checkbox"> Я согласен с правилами и условиями</a>
                            </label>
                          </div>
                        </div>
                      </div>
