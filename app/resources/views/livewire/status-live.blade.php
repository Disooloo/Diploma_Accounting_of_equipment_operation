            ...
            @if($createData)
                <div class="card card-blue float-right col-md-5">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Добавление нового статуса</h3>
                        </div>
                        <div class="card-body">
                            <!-- title -->
            ...
            @else
                <div class="card card-blue float-right col-md-5">
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">редактирование статуса</h3>
                        </div>
                        <div class="card-body">
                            <!-- title -->
                            <div class="form-group">
                ...
                <div class="card card-blue  collapsed-card col-md-6">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a wire:click="edit({{$stat->id}})" type="button" class="btn btn-tool"><i
                                    class="fas fa-pen"></i>
                            </a>
                            <a wire:click="remove({{$stat->id}})" type="button" class="btn btn-tool"><i
