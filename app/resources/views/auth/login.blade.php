    ...
    <div class="container register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <p>Система по учету работы оборудования!</p>
            </div>
            <div class="col-md-9 register-right">
                <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active mb-2" id="login-tab" data-toggle="tab" href="#login" role="tab"
                           aria-controls="login" aria-selected="true">Войти</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mb-2" id="newuser-tab" data-toggle="tab" href="#newuser" role="tab"
                           aria-controls="newuser" aria-selected="false">Регистрация</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                        <h3 class="register-heading">Авторизация администратора </h3>
                            ...
                            <div class="col-md-12 profile_card">
                                ...
                                <form class="form-inline" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="float-right">
                                        <input type="submit" class="btn btn-primary" value=" {{ __('Войти') }}"/>
                                    </div>
                                </form>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input id="password-confirm" type="password" class="form-control" placeholder="Повторите пароль *"
